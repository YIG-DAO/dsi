...
#
# However, when we do this, we also import `dstifbot/__init__.py'. If this
...
setup_dict = dict(
    ...
    entry_points={
        "console_scripts": ["dstifbot = dstifbot.main:entry_point"],
        # if you have a gui, use this
        # 'gui_scripts': [
        #     'dstifbot_gui = dstifbot.gui:entry_point'
        # ]
    },
)
