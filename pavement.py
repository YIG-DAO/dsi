...
sys.path.append(".")
from paver.easy import consume_args, needs, options, task
...
def run(args):
    ...
    from dstifbot.main import main
...
def doc_open():
    ...
    if sys.platform == "darwin":
        ...
        print_failure_message(
            "Unsupported platform. Please open `{0}' manually.".format(doc_index)
        )
